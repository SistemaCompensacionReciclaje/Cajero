<?php 
    ...
    $id = $_SESSION['id_oferta1'];
    $nombre = $_SESSION['nombre_oferta1'];
    $descripcion = $_SESSION['descripcion_oferta1'];
    $valor = $_SESSION['valor_oferta1'];
    ...
    $msg = wordwrap($msg,70);
    mail("harold.216@hotmail.com","Oferta Canjeada","Hola");
    */
