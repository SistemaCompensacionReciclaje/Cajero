<?php 
    ...
    $id = $_SESSION['id_oferta4'];
    $nombre = $_SESSION['nombre_oferta4'];
    $descripcion = $_SESSION['descripcion_oferta4'];
    $valor = $_SESSION['valor_oferta4'];
    ...
    $msg = wordwrap($msg,70);
    mail("$CorreoElectronico","Oferta Canjeada","Hola");
    */
