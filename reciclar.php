...
<header>
	...
	<div class="container">
		...
		<div id="divblanco" class="main row">
			...
			<div class="col-md-6">
				<br>
				<a class="btn btn-lg btn-block btn-success" href="plastico.php">Plástico</a>
				<br>
				<br>
				<br>
				<a class="btn btn-lg btn-block btn-success" href="lata.php">Metal</a>
				<br>
				<br>
				<br>
				<a class="btn btn-lg btn-block btn-success" href="vidrio.php">Vidrio</a>
				<br>
				<br>
				<br>
				<a class="btn btn-lg btn-block btn-success" href="principal.php">Finalizar</a>
			</div>	
		</div>
